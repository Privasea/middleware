...
func (m *MockAuth) Check(userToken, apiServerName, apiMethod, apiPath, address string) (bool, error) {
	args := m.Called(userToken, apiServerName, apiMethod, apiPath, address)
...
func TestGinInterceptor(t *testing.T) {
	...
	t.Run("valid token", func(t *testing.T) {
		...
		// 模拟Check方法返回的值
		mockAuth.On("Check", "valid_token", "test_server", "GET", "/admin/test", "address").Return(true, nil)
	...
	t.Run("invalid token", func(t *testing.T) {
		...
		// 模拟Check方法返回的值
		mockAuth.On("Check", "invalid_token", "test_server", "GET", "/admin/test", "address").Return(false, nil)
	...
	t.Run("error in check", func(t *testing.T) {
		...
		// 模拟Check方法返回错误
		mockAuth.On("Check", "any_token", "test_server", "GET", "/admin/test", "address").Return(false, fmt.Errorf("internal error"))
